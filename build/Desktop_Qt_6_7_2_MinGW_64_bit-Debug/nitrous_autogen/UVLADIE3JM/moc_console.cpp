...
struct qt_meta_stringdata_CLASSConsoleENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSConsoleENDCLASS = QtMocHelpers::stringData(
    "Console",
    "appendText",
    "",
    "text"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSConsoleENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Console::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSConsoleENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Console, std::true_type>,
        // method 'appendText'
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->appendText((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
