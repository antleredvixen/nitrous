...
struct qt_meta_stringdata_CLASSAboutENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAboutENDCLASS = QtMocHelpers::stringData(
    "About"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAboutENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject About::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAboutENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAboutENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAboutENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *About::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAboutENDCLASS.stringdata0))
