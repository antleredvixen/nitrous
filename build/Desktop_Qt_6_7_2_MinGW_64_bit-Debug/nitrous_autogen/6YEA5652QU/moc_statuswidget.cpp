...
struct qt_meta_stringdata_CLASSStatusWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSStatusWidgetENDCLASS = QtMocHelpers::stringData(
    "StatusWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStatusWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject StatusWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSStatusWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStatusWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStatusWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *StatusWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStatusWidgetENDCLASS.stringdata0))
